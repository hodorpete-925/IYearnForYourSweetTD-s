/*
 * build_deck.js — 2026 Beach Summit deck generator (consolidated).
 ...
 * "Pete Hodor"; Q6 efficiency answer (when present in the data pack).
 * Usage: node build_deck.js [datapack.md] [out.pptx] [assetsDir] [keeperJson]
 */
const fs = require("fs");
...
tbl(s, ["Manager", "Wk", "Pts", "Opponent", "Opp pts"], weeklyHigh, { y: 1.32, w: 9.0, fs: 10, colW: [2.0, 0.6, 1.0, 2.0, 1.0], numCols: [1, 2, 4] });
...
tbl(s, ["Player", "NFL opp", "Wk", "Pts", "Manager", "Result", "Score (for-vs)", "vs Manager"], bestWeeks,
  { y: 1.2, fs: 9, colW: [1.6, 0.85, 0.4, 0.55, 1.5, 0.65, 1.5, 1.4], numCols: [2, 3] });
