/*
 * build_deck_v2.js — 2026 Beach Summit deck generator (consolidated).
 * Standings drawn ICON images; keeper menus from keeper_data.json; trades ✓/✗;
 * Jon -> "Manager TBD"; "Pete Hodor"; emoji stripped from team names;
 * Highest single-week scores MIRRORS Biggest blowouts (Manager|Wk|Opponent|Score|Margin);
 * Best individual weeks has a season-rank # column; Q6 efficiency when in data pack.
 * Usage: node build_deck_v2.js [datapack.md] [out.pptx] [assetsDir] [keeperJson]
 */
const fs = require("fs");
